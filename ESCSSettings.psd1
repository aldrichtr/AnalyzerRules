@{
    ...
    MainModuleDirectory = '.\source\AnalyzerRules'

    # The relative path from the current workspace to the main module manifest file.
    SourceManifestPath = '.\source\AnalyzerRules\*.psd1'
    ...
    MarkdownDocsPath = '.\docs\AnalyzerRules'

    # The relative path(s) from the current workspace to the directory(ies) where functions are stored.
    FunctionPaths = '.\source\AnalyzerRules\public', '.\source\AnalyzerRules\private'
    ...
    CommandSplatRefactor = @{
        ...
        AdditionalParameters = 'Mandatory'
    ...
    UsingStatements = @{
        ...
        UsingKindOrder = 'Namespace', 'Module','Assembly'
      }
}
